    ...
    return(
        <footer className="footer">
            <div className="content has-text-centered">
                ...
                <p className="is-size-6">If you notice any mistakes, please contact me on my main page <a href="https://thomaswicks.com/#contactMe" target="_blank" rel="noopener noreferrer" className="is-size-6 hvr-sweep-to-right text-highlight has-text-weight-bold">here</a>
                </p>
